...
const projects = [
  {
    title: "Moottorin täyshuolto",
    category: "Perämoottori",
    image: "/neon-finance-app-interface-dark-mode.jpg",
    color: "from-blue-500/20 to-cyan-500/20",
  },
  {
    title: "Sähköjärjestelmän uusinta",
    category: "Sisävene",
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          <div>
            ...
            >
              Esimerkkejä toteuttamistamme huoltotöistä.
            </motion.p>
          </div>
          <motion.button
                  ...
                  <div className={`p-12 flex flex-col justify-center relative overflow-hidden`}>
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-white/70 mb-8 max-w-md">
                        Ammattitaitoinen huolto suoritettiin asiakkaan veneenpaikalla sovitun aikataulun mukaisesti.
                      </p>
                      <div className="flex items-center gap-4 text-sm font-medium">
                        <span className="px-4 py-2 rounded-full bg-white/5 border border-white/10">Huolto</span>
                        <span className="px-4 py-2 rounded-full bg-white/5 border border-white/10">Korjaus</span>
                      </div>
                    </div>
                  </div>
