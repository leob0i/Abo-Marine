          ...
          >
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              ...
              <div className="flex gap-4">
                <Link
                  href="https://www.instagram.com/abomarineservice/"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Seuraa meitä Instagramissa"
                  className="inline-flex h-12 w-12 items-center justify-center rounded-full ring-1 ring-white/20 text-white transition hover:scale-105"
                ...
                <Link
                  href="https://www.facebook.com/profile.php?id=61557035757418"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Seuraa meitä Facebookissa"
                  className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-[#1877F2] ring-1 ring-white/20 text-white transition hover:bg-[#1467d6] hover:scale-105"
                >
                  <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden="true">
